ActiveAdmin.setup do |config|
  ...
  # allows active admin to peform mass assignment for protected attributes (using rails 3.1.x :as role)
  ...
  # change the footer...    <---  Should probably do this, need new active admin gem tho
  ...
  #
  config.site_title = "ADMIN - Intl Gum"
